...
Revision ID: 4ee806da82b8
Revises: 
Create Date: 2026-09-14 13:33:32.129254
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'PROCESSING', 'IN_PROGRESS', 'DELIVERED', 'CANCELED', name='orderstatus'), nullable=False),
